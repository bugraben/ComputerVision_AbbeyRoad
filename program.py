...
outputFrame = np.zeros((in_height,in_width,2), dtype="uint8")

def processChannel(channel = None, frames = None):
...
if __name__ == '__main__':
    ...
    p_blue = Process(target=processChannel, args=(0, frames,))
